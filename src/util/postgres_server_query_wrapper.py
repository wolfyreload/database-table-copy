...
class PostgresServerQueryWrapper:
    """
    ...
    def __init__(self, connection_properties: SQLConnectionProperties):
        self.connection_string = connection_properties.postgres_connection_string
    ...
    def execute_sql_with_no_results(self, query: str, parameters=None) -> None:
        ...
        """
        with psycopg2.connect(**self.connection_string) as connection:
            self.get_query_cursor(connection, query, parameters)
